...
<html>
	<head>
		...
		<title><?php echo $_SESSION['user_name']; ?> Home Page</title>
	</head>
<body>
	<header>
		...
		<div id="user_posts">
			...
			<form action="" method="post" id="edit_user_form" class="animated" enctype="multipart/form-data">
				...
				<table id="edit_user_table">
					<tr>
						<td><label for="user_name" class="lable">User Name: </label></td>
						<td><input type="text" name="user_name" value="<?php echo $_SESSION['user_name']; ?>" required="required" /></td>
					</tr>
					<tr>
						<td><label for="user_pass" class="lable">Password: </label></td>
						<td><input type="password" name="user_pass" placeholder="*******" required="required" /></td>
					</tr>
					<tr>
						<td><label for="user_email" class="lable">Email: </label></td>
						<td><input type="email" name="user_email" required="required" value="<?php echo $_SESSION['user_email']; ?>" /></td>
					</tr>
					<tr>
						<td><label for="user_country" class="lable">Country: </label></td>
						<td>
							<select name="user_country" disabled="disabled" style="width: 73%;">
								<option><?php echo $_SESSION['user_country']; ?></option>
					...
					<tr>
						<td><label for="user_gender" class="lable">Gender: </label></td>
						<td>
					...
					<tr>
						<td><label for="user_b_day" class="lable">Birthe Day: </label></td>
						<td><input type="date" name="user_b_day" value="<?php echo $_SESSION['user_b_date']; ?>" /></td>
					</tr>
					<tr>
						<td><label for="user_image">User Image: </label></td>
						<td><input type="file" name="u_image"/></td>
					</tr>
					<tr>
						<td></td>
						<td><button name="update_profile" class="btn animated tada" style="margin-top: 20px;">Update Profile</button></td>
					</tr>
				</table>
			</form>
			<?php 
