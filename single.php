...
<body>
	<header>
    	<a href="/social_network/home.php"><img class="animated infinite pulse" src="images/logo.png"  /><span class="headertitle animated flipInY">Web FreeLancer!</span></a>
	<div id="home_links">
		<a href="logout.php" class="action-button shadow animatebutton blue animated tada">LogOut</a>
		<a href="includes/edit_user.php" class="action-button shadow animatebutton blue">Edit Profile</a>
